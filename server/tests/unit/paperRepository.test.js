...
function expectFetchPaperAuthorsQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperAuthorsById", () => {
    ...
    it("Fetches the authors associated with a particular paper", async () => {
        ...
        expectFetchPaperAuthorsQuery(query);
        expect(params).toEqual(["386866"]);

        expect(results).toEqual(mockResolvedPaperAuthors);
    });

    it("Fetches an empty array for an invalid internal paper id", async () => {
        pool.query.mockResolvedValue({
            rows: []
        });

        const results = await fetchPaperAuthorsById("38686");

        const [query, params] = pool.query.mock.calls[0];

        expectFetchPaperAuthorsQuery(query);
        expect(params).toEqual(["38686"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperAuthorsById("386866"))
        .rejects
...
function expectFetchPaperInstitutionsQuery(query) {
...
describe("fetchPaperAuthorInstitutions", () => {
    ...
    it("Fetches the institutions associated with the authors that correspond to a particular paper", async () => {
        ...
        expectFetchPaperInstitutionsQuery(query);
        expect(params).toEqual(["386866"]);

        expect(results).toEqual(results);
    });

    it("Fetches an empry array for an invalid internal paper id", async () => {
        pool.query.mockResolvedValue({
            rows: []
        });

        const results = await fetchPaperAuthorInstitutionsById("3868");

        const [query, params] = pool.query.mock.calls[0];
        
        expectFetchPaperInstitutionsQuery(query);
        expect(params).toEqual(["3868"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperAuthorInstitutionsById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperAffiliationsQuery(query) {
...
describe("fetchPaperAuthorAffiliations", () => {
    ...
    it("Fetches the affiliations associated with the authors that correspond to a particular paper", async () => {
        ...
        expectFetchPaperAffiliationsQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("Fetches an empty array for an invalid internal paper id", async () => {
        ...
        const results = await fetchPaperAuthorAffiliationsById("3868");
    ...
    it("An unexpected database occurs", async () => {
        ...
        await expect(fetchPaperAuthorAffiliationsById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperTopicsQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperTopics", () => {
    ...
    it("Fetches the topics associated with a particular paper", async () => {
        ...
        expectFetchPaperTopicsQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperTopicsById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperKeywordsQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperKeywords", () => {
    ...
    it("Fetches the keywords associated with a particular paper", async () => {
        ...
        expectFetchPaperKeywordsQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperKeywordsById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperLocationsQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperLocations", () => {
    ...
    it("Fetches the locations associated with a particular paper", async () => {
        ...
        expectFetchPaperLocationsQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperLocationsById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperReferencesQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperReferences", () => {
    ...
    it("Fetches the references associated with a particular paper", async () => {
        ...
        expectFetchPaperReferencesQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperReferencesById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperRelatedQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperRelated", () => {
    ...
    it("Fetches the related paper ids associated with a particular paper", async () => {
        ...
        expectFetchPaperRelatedQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperRelatedById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
...
function expectFetchPaperCountsByYearQuery(query) {
    expect(query).toContain("SELECT *");
...
describe("fetchPaperCountsByYear", () => {
    ...
    it("Fetches the citation counts by year associated with a particular paper", async () => {
        ...
        expectFetchPaperCountsByYearQuery(query);
        expect(params).toEqual(["386866"]);
    ...
    it("An unexpected database error occurs", async () => {
        ...
        await expect(fetchPaperCountsByYearById("386866"))
        .rejects
        .toThrow("Unexpected DB error");
